...
public class FrFileInfo {
	...
	public FrFileInfo(int fileNo, String fileName, String changeName, Date fileCreateDate, int fileLevel,
	...
	public String toString() {
		return "FrFileInfo [fileNo=" + fileNo + ", fileName=" + fileName + ", changeName=" + changeName
