...
<c:import url="../common/header.jsp"/>
	<div class="termsArea">
			<h1>약관동의</h1>
				...
				<input type="checkbox" name="check" value="check2" id="check2"><label>&nbsp;이용약관 동의 <strong style="color:red">&nbsp;(필수)</strong></label>
			<pre>
			
제1조 목적
			
본 이용약관은 “YELLOWBRIDGE”(이하 "사이트")의 서비스의 이용조건과 운영에 관한 제반사항 규정을 목적으로 합니다.
...
이 약관은 <사이트 개설일> 부터 시행합니다.
			...
			<br><br>
			<input type="checkbox" name="check" value="check3" id="check3"><label>&nbsp;개인정보 수집 및 이용<strong style="color:red">&nbsp;(필수)</strong></label>
