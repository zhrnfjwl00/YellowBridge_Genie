...
<div class="serviceform">
	...
	<form action="adminVolUpdate.vol" method="post" encType="multipart/form-data">
		...
		<div class="apply-bottom">
			<div id="apply-info2">
				<textarea id="summernote" cols="140" rows="15" name="serviceContent" placeholder="봉사에 관한 자세한 설명을 입력해주세요." style="resize:none;" required>${ adadmin.serviceContent }</textarea>
			</div>
