...
<div class="board_request">
	<form method="post" name="form" action="" enctype="multipart/form-data" accept-charset="utf-8">
		<input type="hidden" name="animalNo" value="adoption">
		<input type="hidden" name="animalType" value="/">
		<input type="hidden" name="animalGender" value="/">
		<input type="hidden" name="animalAge" value="/">
		<input type="hidden" name="animalColor" value="210626-0006">
		<input type="hidden" name="animalTnr" value="1">
		<input type="hidden" name="animalCharacter" value="1">
		<input type="hidden" name="animalWeight" value="1">
		<input type="hidden" name="animalCondition" value="1">
		<input type="hidden" name="animalFeature" value="1">
		<input type="hidden" name="rescueDate" value="1">
		<input type="hidden" name="rescueLocation" value="1">
...
<%-- 				<col width="25%">
			...
			<tbody>
				<tr>
					...
					<td colspan="3">
						<input type="radio" id="F" name="animalGender"><label for="F">암컷</label>
						<input type="radio" id="M" name="animalGender"><label for="M">수컷</label>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<input type="radio" id="animalTnr1" name="animalTnr" value="Y"><label for="animalTnr1">했음</label>
					...
					<td><input type="text" id="select" name="select" value="" maxlength="6" class="form-control"></td>
				</tr>
				<tr>
